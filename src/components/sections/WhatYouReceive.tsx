...
const deliverables = [
  {
    title: "Automation risk positioning",
    description:
      "Understand how AI exposure may show up in your current work patterns—not as alarm, but as context.",
    icon: (
  ...
  {
    title: "Career resilience profile",
    description:
      "See where human judgment, adaptability, and trust still define your professional advantage.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  return (
    <Section id="receive">
      <SectionHeader
        ...
        title="A complete picture of your AI career resilience."
        description="Automation risk, resilience positioning, and a personal career profile—structured for calm, executive reflection."
        align="center"
      />
