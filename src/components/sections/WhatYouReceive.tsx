...
const deliverables = [
  {
    title: "AI Replacement Risk result",
    description:
      "Get one clear primary outcome: how high the replacement risk is for your selected profession.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Understand the human advantage factors and risk drivers behind your result without formula overload.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  {
    title: "RIASEC profession context",
    description:
      "See your primary and secondary occupational orientation as context for interpreting replacement risk.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  return (
    <Section id="receive">
      <SectionHeader
        ...
        title="One clear outcome, plus supporting context."
        description="AI Replacement Risk as the primary result, with human factors and profession context for calm, actionable interpretation."
        align="center"
      />
